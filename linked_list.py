...
class LinkedList:
  ...
  def add(self, data):
    ...
    """
    Adds new Node containing data at head og the lis
  ...
  def search(self, key):
    ...
    Return the nide or "None" if not found
    Takes 0(n) == Linear search time
    """
  ...
  def remove(self, key):
    ...
    Returns the node or None if ket doesn't exist
    Takes O(n) time
    """
